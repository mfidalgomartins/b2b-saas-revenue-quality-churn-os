...
### 9) Scoring calibration outputs
- `scoring_backtest_calibration_by_tier` (grain: risk tier)
- `scoring_backtest_calibration_by_decile` (grain: score decile)

Purpose:
- quantify realized forward churn concentration by score/tier,
- support threshold tuning and governance calibration.
